...
class DatabaseConnector:
    ...
    def __init__(self , table_names = [], yaml_name = '/Users/isaachall/Desktop/MRDC/db_creds.yaml', PASSWORD2 = input('Please input password to database: ')):
        import yaml
    ...
    def upload_to_db(self):
        ...
        if filetype == 'user_data':
            ...
            products_df = DataCleaning.convert_product_weights(products)
        ...
        elif filetype == 'card_data_test':
            upload = DataExtractor()
            data_upload = upload.retrieve_pdf_data()
        elif filetype == 'store_data_test':
            upload = DataExtractor()
            data_upload = upload.retrieve_stores_data()
